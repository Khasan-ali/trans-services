...
export default function Investment() {
    ...
    useEffect(() => {
           axios.get(`https://tashbus.uz/${document.cookie.slice(12)}/api/post/hisobotlar`).then(response => setData(response.data))
    }, [])
        ...
        <ul className={cls.investment_list}>
            {data?.results?.map((element) => (
                <li className={cls.investment_item} key={element?.slug}>
                    ...
                    href={`/modules/activity/activity-layout/reports/${element?.slug}`}>
