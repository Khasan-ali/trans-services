...
export default function DetailInvestment({ params }) {
    ...
    const t = useTranslations("Activity-Reports")
    ...
    return <div className={cls.detail}>
        ...
        <div className="hero-dinamic-router">
            ...
            <Link className='hero-dinamic-route-link' href={`/modules/activity/activity-layout/reports`}>{t('route2')}</Link>
            <Image className='hero-dinamic-route-images' src={NextImg} alt='next images' />
            <Link className='hero-dinamic-route-link' href={`/modules/activity/activity-layout/reports`}>{t('route3')}</Link>
        </div>
