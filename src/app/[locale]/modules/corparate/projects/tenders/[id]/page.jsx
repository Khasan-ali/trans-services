...
export default function DetailInvestment({ params }) {
    ...
    const t = useTranslations("Corparate-Projects-Tenders")
    ...
    return <div className={cls.detail}>
        ...
        <div className="hero-dinamic-router">
            ...
            <Link className='hero-dinamic-route-link' href={`/modules/corparate/projects/tenders`}>{t('route2')}</Link>
            <Image className='hero-dinamic-route-images' src={NextImg} alt='next images' />
            <Link className='hero-dinamic-route-link' href={`/modules/corparate/projects/tenders`}>{t('route3')}</Link>
            <Image className='hero-dinamic-route-images' src={NextImg} alt='next images' />
            <Link className='hero-dinamic-route-link' href={`/modules/corparate/projects/tenders`}>{t('route4')}</Link>
        </div>
