...
export default function DetailInvestment({ params }) {
    ...
    return <div className={cls.detail}>
        ...
        <div className="hero-dinamic-router">
            ...
            <Link className='hero-dinamic-route-link' href={`/modules/corparate/projects/purchaches`}>{t('route2')}</Link>
            <Image className='hero-dinamic-route-images' src={NextImg} alt='next images' />
            <Link className='hero-dinamic-route-link' href={`/modules/corparate/projects/purchaches`}>{t('route3')}</Link>
            <Image className='hero-dinamic-route-images' src={NextImg} alt='next images' />
            <Link className='hero-dinamic-route-link' href={`/modules/corparate/projects/purchaches`}>{t('route4')}</Link>
        </div>
        ...
        <p className={cls.detail_body}>{data?.title}</p>
    </div>
}